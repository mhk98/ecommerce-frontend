...
import { MdOutlineFeaturedPlayList, MdOutlineKeyboardArrowLeft, MdOutlineKeyboardArrowRight } from 'react-icons/md';
...
const FeatureProduct = ({loading,data}) => {
  ...
  return (
    <div className="border border-gray-100 mt-3  bg-white rounded-md pt-2">
